  ...
  return (
    <nav
      className={`${
        ...
        scrolled ? "bg-primary bg-opacity-20" : ""
      }`}
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
            ...
            <li
              ...
              className={`${
                active === link.title
                  ...
                  : `text-white-400`
              } hover:text-white hover:scale-125 transition-transform text-[18px] font-medium cursor-pointer`}
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          ...
          <div
            className={`${
              !toggle ? "hidden" : "flex"
            } p-6 transparent absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}
          >
            <ul className="list-none flex justify-end items-start flex-col gap-4">
              {navLinks.map((link) => (
                <li
                  ...
                  } font-poppins font-medium cursor-pointer text-[16px] text-white`}
                  onClick={() => {
                    setToggle(!toggle);
